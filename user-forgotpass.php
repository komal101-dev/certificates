  ...
  <body style="background-color:blanchedalmond;">
    <div class="user">
     ...
     <div class="center">
      ...
      <input class="input1" type="text" name="usn" placeholder="enter usn NO"><br><br></div>
      <div class="inputbox">
      <i class="fas fa-lock icon2"></i>
      <input class="input1" type="text" name="dob" placeholder="Enter DOB"><br></div>
...
if(isset($_POST['change']))
{
   ...
   $usn=$_POST['usn'];
   $dob=$_POST['dob'];
    $sql="select * from student where usn='$usn'and dob='$dob'";
    ...
    if($rows>0)
    {
         ...
         echo"<script>";
         echo"swal('your password is $password','success');";
         echo"</script>";
    }
    else{
